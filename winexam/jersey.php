...
<head>
	<meta charset="utf-8">
	<title>PSG 2021/2022 Thrid Jersey | eZBuy | Online Shopping Mall</title>
...
<body>
  <div class="container">
  	<div class="navbar">  <!-- refered https://www.youtube.com/watch?v=hKd82PD03nY&t=419s for all query string usages-->
  	  <div class="logo">
		...
		<table>
			...
			<tr>
				<td>  <!-- Used the reference https://www.youtube.com/watch?v=ENyk_W-Eleo to get the idea -->
			...
			<tr>
				<td><center><h3>Ratings; </h3> 
					<span class="fa fa-star checked"></span>
 					<span class="fa fa-star checked"></span>   <!-- Refered to https://www.w3schools.com/ to get the ratings code -->
 					<span class="fa fa-star checked"></span>
 					<span class="fa fa-star checked" ></span>
...
$result=$conn->query($sql);
	...
	while($row = $result->fetch_assoc()){  /* Refered to labsheets */
?>						
						<tr>
